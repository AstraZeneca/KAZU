    ...
    def _find_abbreviations_and_override_entities(
        ...
        for section, spacy_doc in section_to_spacy_doc.items():
            ...
            for match, start, end in global_matches:
                ...
                abbrv_ents_at_index_by_namespace = defaultdict(set)
                for ent in section_to_ents_by_char_index[section].get(abbrv_char_index_key, set()):
                    abbrv_ents_at_index_by_namespace[ent.namespace].add(ent)
