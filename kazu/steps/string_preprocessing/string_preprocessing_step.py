...
class StringPreprocessorStep(BaseStep):
    """
    String Preprocessing steps (subclass of :class:`kazu.steps.string_preprocessing.StringPreprocessorStep` are a
    ...
    passed to another :class:`kazu.steps.base.step.Step`.  Implementations of this step update the
