...
class OntologyResourceSetMergeReport:
    ...
    #: human resources that are actively overriding the autogenerated resource from the parser data
...
class OntologyResourceSetCompleteReport:
    ...
    #: generic parser metadata
    metadata: dict[str, dict[str, SimpleValue]]
