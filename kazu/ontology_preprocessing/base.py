...
class OntologyParser(ABC):
    ...
    def export_metadata(self, parser_name: str) -> OntologyMetadata:
    ...
    def resolve_autogenerated_resources(
        ...
        if not self.ontology_auto_generated_resources_set_path.exists():
            clean_resources = self.generate_clean_default_resources(candidates)
    ...
    def create_human_conflict_report(self) -> OntologyResourceSetConflictReport:
    ...
    def create_combined_conflict_report(
    ...
    def upgrade_ontology_version(self) -> OntologyUpgradeReport:
        ...
        changing the configuration of the :class:`.AutoCurator`\\. Generate a report
        that describes the differences in generated :class:`OntologyStringResource`\\s
        ...
        new_version_auto_generated_resources_clean = self.generate_clean_default_resources(
    ...
    def _populate_databases(
        ...
        ) = self.process_candidates_and_string_resources(
    ...
    def populate_metadata_db_and_resolve_string_resources(
        ...
        auto_generated_resources_clean = self.resolve_autogenerated_resources(
            intermediate_linking_candidates
        )
        ...
        human_resource_report = self.create_human_conflict_report()

        merge_report = self.create_merge_report(
