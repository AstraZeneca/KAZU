...
class MnliProcessor(SeqClsProcessor):
...
class Sst2Processor(SeqClsProcessor):
...
class StsbProcessor(SeqClsProcessor):
...
class QqpProcessor(SeqClsProcessor):
    """Processor for the STS-B data set (GLUE version)."""
...
class QnliProcessor(SeqClsProcessor):
    """Processor for the STS-B data set (GLUE version)."""
...
class RteProcessor(SeqClsProcessor):
...
class WnliProcessor(SeqClsProcessor):
